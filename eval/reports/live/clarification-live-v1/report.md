...
- Run: clarification-live-v1
- Mode: live
- Timestamp: 2026-04-16T08:32:21.533821
...
- Automatic thought hit rate: 0.72
- Emotion label hit rate: 0.77
- Behavior hit rate: 0.83
- Clarification accuracy: 0.72
...
- Emotion misses: 14
- Missed cases: case-012, case-013, case-015, case-023, case-024, case-030, case-049, case-058, case-059, case-033, case-034, case-036, case-038, case-039

## Automatic Thought Miss Summary

- Automatic thought misses: 17
- Automatic thought tagged cases: 20
- Automatic thought subset hit rate: 0.70
- Missed cases: case-005, case-013, case-017, case-018, case-020, case-024, case-026, case-028, case-046, case-048, case-053, case-054, case-032, case-038, case-040, case-041, case-045
...
- Distortion subset top-3 hit rate: 0.92
- Missed cases: case-004, case-026, case-050

## Case Errors

- `case-001`: behavior_miss
- `case-003`: behavior_miss, clarification_miss
- `case-004`: situation_miss, behavior_miss, distortion_miss
- `case-005`: automatic_thought_miss
- `case-006`: clarification_miss
- `case-008`: situation_miss, clarification_miss
- `case-012`: emotion_miss
- `case-013`: automatic_thought_miss, emotion_miss, clarification_miss
- `case-014`: clarification_miss
- `case-015`: emotion_miss, clarification_miss
- `case-016`: clarification_miss
- `case-017`: automatic_thought_miss
- `case-018`: automatic_thought_miss
- `case-020`: automatic_thought_miss, clarification_miss
- `case-022`: behavior_miss
- `case-023`: emotion_miss, behavior_miss, clarification_miss
- `case-024`: automatic_thought_miss, emotion_miss, behavior_miss
- `case-026`: automatic_thought_miss, distortion_miss
- `case-028`: automatic_thought_miss
- `case-030`: emotion_miss, clarification_miss
- `case-046`: automatic_thought_miss, behavior_miss
- `case-048`: automatic_thought_miss
- `case-049`: emotion_miss, clarification_miss
- `case-050`: distortion_miss
- `case-051`: clarification_miss
- `case-053`: automatic_thought_miss
- `case-054`: automatic_thought_miss
- `case-055`: behavior_miss, clarification_miss
- `case-056`: clarification_miss
- `case-057`: behavior_miss
...
- `case-036`: emotion_miss, clarification_miss
- `case-038`: automatic_thought_miss, emotion_miss
- `case-039`: emotion_miss, clarification_miss
