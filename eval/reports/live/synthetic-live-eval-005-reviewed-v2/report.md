...
- Mode: live
- Timestamp: 2026-04-17T04:27:20.203244
- Dataset: synthetic_gad_dev_live_002_reviewed (synthetic-reviewed-v2)
...
- Total cases: 20
- Automatic thought subset hit rate: 0.87
- Distortion subset top-3 hit rate: 1.00
- Clarification subset accuracy: 0.00
- Situation hit rate: 0.30
- Automatic thought hit rate: 0.90
- Emotion label hit rate: 1.00
- Behavior hit rate: 0.85
...
- Case count: 20
- Case mix: automatic_thought=15, clarification=0, distortion=7, emotion_behavior=4, risk=1
...
- Automatic thought misses: 2
- Automatic thought tagged cases: 15
- Automatic thought subset hit rate: 0.87
- Missed cases: synthetic_reviewed_0007, synthetic_reviewed_0015
...
- `synthetic_reviewed_0003`: situation_miss, behavior_miss
- `synthetic_reviewed_0004`: situation_miss
- `synthetic_reviewed_0005`: situation_miss
- `synthetic_reviewed_0007`: situation_miss, automatic_thought_miss
...
- `synthetic_reviewed_0015`: automatic_thought_miss
- `synthetic_reviewed_0016`: situation_miss
- `synthetic_reviewed_0017`: situation_miss
- `synthetic_reviewed_0018`: situation_miss
- `synthetic_reviewed_0019`: situation_miss, behavior_miss
- `synthetic_reviewed_0020`: situation_miss
